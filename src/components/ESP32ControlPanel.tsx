...
const [hasColorForSchedule, setHasColorForSchedule] = useState(false);
...
if (client) {
// jika ESP32 pakai RGBON / RGBOFF, bisa diubah di sini
...
if (!hasColorForSchedule || (rgb.r === 0 && rgb.g === 0 && rgb.b === 0)) {
  toast.error("Please set RGB color before creating schedule");
  return;
}
